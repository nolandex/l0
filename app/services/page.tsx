  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6">
      <div
        ...
        } rounded-xl overflow-hidden shadow-2xl relative p-4 sm:p-6`}
      >
        <button
          onClick={onClose}
          className={`absolute top-4 right-4 p-2 rounded-md transition-all duration-200 z-10 ${
            theme === "dark"
...
function OrderingInstructions() {
  ...
  return (
    <div className="space-y-4">
      <h3 className={`text-base sm:text-lg font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Cara Pemesanan</h3>
...
export default function ServicesPage() {
  ...
  const getButtonClasses = (isActive: boolean) => {
    const baseClasses = "px-3 py-1.5 rounded-lg font-medium text-xs sm:text-sm transition-all duration-300 whitespace-nowrap"
  ...
  return (
    <div className={`min-h-screen pt-20 pb-8 ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"} px-4 sm:px-6 md:px-8`}>
      <div className="max-w-7xl mx-auto">
        {/* Category Buttons with Horizontal Scroll */}
        <div className="flex gap-2 sm:gap-3 mb-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
          <button
            onClick={() => setActiveCategory("paket_bisnis")}
              ...
              {group.map((product) => {
                ...
                return (
                  <div
                    ...
                    className={`flex flex-col rounded-lg overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md snap-start ${
                  ...
                  >
                        ...
                        <div className="mb-3 space-y-2">
                          {displayProduct.name === "Instagram" && (
                            <select
                              ...
                              className={`w-full px-2 py-1.5 rounded-md text-xs sm:text-sm border ${
                                theme === "dark"
                          ...
                          <input
                            ...
                            className={`w-full mt-2 px-2 py-1.5 rounded-md text-xs sm:text-sm border ${
                              theme === "dark"
                    ...
                    <div className="flex gap-2 mt-auto">
                      <button
                        className={`flex-1 py-1.5 px-3 rounded-md font-medium text-xs sm:text-sm transition-all duration-300 shadow-sm hover:shadow-md ${
                          theme === "dark"
                      ...
                      {displayProduct.exampleUrl && displayProduct.category === "website" && (
                        <a
                          ...
                          className={`px-2 py-1.5 rounded-md font-medium text-xs sm:text-sm transition-all duration-300 border flex items-center gap-1 shadow-sm hover:shadow-md ${
                            theme === "dark"
        ...
        <Modal
          ...
          size="lg"
        >
          <Swiper spaceBetween={10} slidesPerView={1} className="w-full h-48 sm:h-64 md:h-96">
            {modalProduct &&
              imageSources[modalProduct.modalType as keyof typeof imageSources]?.map((img, i) => (
                <SwiperSlide key={i}>
                  <div className="relative w-full h-full">
                    ...
                    />
                    <span
                      className={`absolute top-2 left-2 px-2 py-1 text-xs sm:text-sm font-medium text-white bg-black bg-opacity-60 rounded`}
                    >
                      Gambar {i + 1}
                    </span>
                  </div>
