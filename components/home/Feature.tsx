...
const Feature = ({
  ...
  // Logika ini akan mengambil FEATURES_ZH jika langName yang masuk adalah "zh"
  const FEATURES =
        ...
        <div className="mx-auto grid justify-center gap-4 text-center sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          {FEATURES.map((feature) => (
            ...
            >
              ...
              {/* Title (diedit di sini) */}
              <h3 className="text-base font-semibold text-white mb-0.5 mt-[-4px]">
                {feature.title.toUpperCase()} {/* Hanya perubahan ini yang diterapkan */}
              </h3>
